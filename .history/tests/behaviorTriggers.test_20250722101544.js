...
async function testBehaviorTriggers() {
  ...
  const experiencedTrigger = await behaviorTriggerService.evaluateTriggers(experiencedUserBehavior, { betAmount: 150 });
  ...
  const recoveryTrigger = await behaviorTriggerService.evaluateTriggers(recoveryBehavior, { betAmount: 120 });
